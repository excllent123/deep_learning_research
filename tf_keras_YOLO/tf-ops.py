...
Gist
 ...
 Watch 3,443
  Unstar 37,418
  Fork 17,009 tensorflow/tensorflow
 Code  Issues 605  Pull requests 33  Projects 0  Pulse  Graphs
Branch: master Find file Copy pathtensorflow/tensorflow/python/ops/nn.py
85eeec0  a day ago
@jhseu jhseu Automated rollback of change 139400135
20 contributors @vrv @tensorflower-gardener @vincentvanhoucke @keveman @drpngx @benoitsteiner @mrry @ebrevdo @martinwicke @josh11b @jhseu @yuanbyu @zhangyaobit @itsmeolivia @lukaszkaiser @ilblackdragon @girving @dave-andersen @danmane @andrewharp
RawBlameHistory    
1439 lines (1189 sloc)  57.4 KB
